...
void MainWindow::refreshCurrentPage(){switch(pages->currentIndex()){case 0:updateDashboard();break;case 1:loadEmployees();break;case 2:loadPositions();break;case 3:loadAttendance();break;case 4:loadEmployeeChoices(payrollEmployee);break;case 5:loadHistory();break;default:break;}}
